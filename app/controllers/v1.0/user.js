...
// 		console.time("dbsearch");
    	...
    	User.find( {$or:[ { displayName: re}, { username: re}]}, { _id : 1,displayName:1,username:1,profileImageUrl:1,coverImageUrl:1,firstName:1,lastName:1 } ).limit(7).lean().exec(function(err, users) {
