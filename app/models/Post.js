...
var Post = new Schema({
    ...
    imageUrlArray           : [{pictureUrl:String,tags:[String]}],
    requests				: [{type: ObjectId, ref: 'User'}],
    // imageUrl                : {pictureUrl:String,tags:[Tags]},
    imageUrl                : {pictureUrl:String, width:Number, height:Number, tags:[String]},
    // imageUrl                : String,
    type					: String,
    capacity				: Number,
    place                   : String,
    expire                  : Date,
    createdBy               : {type: ObjectId, ref: 'Post'},
    attends                 : [{type: ObjectId, ref: 'User'}],
